...
if __name__ == '__main__':
    ...
    print("===tiangan===")
    print(Rules.getTgHe(l))
    print(Rules.getTgChong(l))
    print(Rules.getTgKe(l))

    print("===dizhi===")
    print(Rules.getZhiHe(l))
    print(Rules.getZhiChong(l))
    print(Rules.getZhiXianghai(l))
    print(Rules.getZhiXiangxing(l))
    print(Rules.getZhiSanhe(l))
    print(Rules.getZhiSanheban(l, l))
    print(Rules.getZhiSanhui(l))
