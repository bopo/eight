...
class BZyjClass:
    ...
    def getPaiPan(self):
        print("年：" + self.yZhu.tiangan.getGanName() + " " + self.yZhu.dizhi.getZhiName(), self.yZhu.getNayin(), "旬空 ",
              self.yZhu.getXunkong())

        print("月：" + self.mZhu.tiangan.getGanName() + " " + self.mZhu.dizhi.getZhiName(), self.mZhu.getNayin())

        print("日：" + self.dZhu.tiangan.getGanName() + " " + self.dZhu.dizhi.getZhiName(), self.dZhu.getNayin(), "旬空 ",
